var BattleScene = new Phaser.Class({
  ...
  preload: function () {
    this.load.audio("battle", ["assets/rbl-iamoneabe-opengameart.mp3"]);
  },
  create: function () {
    // Music must be set in SCenes on create and turned off during switches
    battle = this.sound.add("battle", { loop: true });
  ...
  startBattle: function () {
    ...
    var mage = new PlayerCharacter(this, 250, 100, "player", 4, "Mage", 80, 28);
